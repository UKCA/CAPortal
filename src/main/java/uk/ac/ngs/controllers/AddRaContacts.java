...
public class AddRaContacts {
    ...
    @ModelAttribute
    public void populateDefaultModel(@RequestParam(required = false) Integer certId, ModelMap modelMap) {
    ...
    public String addRaContact(@Valid RevokeCertFormBean revokeCertFormBean, BindingResult result,
